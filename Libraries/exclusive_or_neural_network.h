...
public:
    ...
    /// neurons
    /// @todo: Consider making input_values and output_targets as a data member of NeuralNetworkArchitecture
...
protected:
    ...
    void CalculateNeuronValues(
            const std::pair<SynapseIterator,
                            SynapseIterator>& found_synapses);
    ...
    void SetActivationFunctionType(
